...
import { connectTwitter, connectDiscord, connectTelegram, checkSocialConnections, disconnectSocial, sendNotification } from '../../services/socialService';
...
const SocialIntegrationPanel = () => {
  ...
  return (
    <div className="bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-700">
      <h2 className="text-xl font-bold text-white mb-6">Social Media Connections</h2>
