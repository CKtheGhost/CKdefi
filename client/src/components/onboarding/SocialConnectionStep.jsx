// src/components/onboarding/SocialConnectionStep.jsx
...
/**
 * Social Connection step for the onboarding flow
 * 
 * @param {Object} props Component props
 * @param {Object} props.connections Current social connections
 * @param {Function} props.onConnectionsChange Callback for when connections change
 ...
 */
const SocialConnectionStep = ({ 
  connections = { twitter: false, discord: false, telegram: false },
  onConnectionsChange,
  onNext, 
  onBack, 
  onSkip 
  ...
  const [socialConnections, setSocialConnections] = useState(connections);
  ...
  useEffect(() => {
    if (!socialConnections.twitter && !socialConnections.discord && !socialConnections.telegram) {
      // Check for existing connections
      const storedConnections = checkSocialConnections();
      setSocialConnections(storedConnections);
      
      // Notify parent of connections
      if (onConnectionsChange) {
        onConnectionsChange(storedConnections);
      }
    }
  }, [socialConnections, onConnectionsChange]);
  ...
  const hasAnyConnection = Object.values(socialConnections).some(connected => connected);
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">
          Connect your social accounts to receive updates, alerts, and participate in the CompounDefi community.
          This step is optional but enhances your experience.
        </p>
      </div>
      ...
      <div className="flex justify-between mt-8">
        ...
        <div className="space-x-3">
          ...
          <Button
            ...
            disabled={loading}
          >
            {hasAnyConnection ? 'Continue' : 'Skip & Continue'}
          </Button>
        </div>
      </div>
    </div>
