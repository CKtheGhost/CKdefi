...
const { getMemeCoinData } = require('./src/modules/token_tracker');
const { getLatestNews } = require('./src/modules/news_tracker');
const { getPortfolioData } = require('./src/modules/portfolio_tracker');
const { getStakingData, getPersonalizedRecommendations } = require('./src/modules/staking_optimizer');
